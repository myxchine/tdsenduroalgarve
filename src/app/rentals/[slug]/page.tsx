...
export default function ToursList({ params }: { params: { slug: string } }) {
  ...
  return (
    <section className="flex flex-col items-center justify-center w-full pb-8 max-w-4xl mx-auto md:px-0">
      ...
      <section className=" p-6 md:p-0">
        <section className="flex flex-col items-end gap-4 justify-end bg-black/5 rounded-md p-4 w-full md:p-12">
        ...
        <div className="flex flex-col items-center justify-center space-y-4 w-full w-full bg-black/5 rounded-md p-4 max-w-xl mx-auto md:p-12">
          <h4 className="text-2xl    uppercase font-tds tracking-wider w-full">
            GUIDED TOUR
          </h4>
          <p className="w-full text-sm text-black/80">
