...
export default function Hero() {
  return (
    <section className="text-foreground flex flex-col items-center justify-center gap-0  md:gap-4 relative  tmt-[-88px]  tmd:mt-[-96px]">
      <HeroImage />
      <Title />
    </section>
  );
  ...
  return (
    <section className="w-full flex ">
      <Image
        ...
        width={800}
        height={800}
        className=" object-cover object-left  w-full h-[400px] md:h-[600px] lg:h-[800px] "
      />
    </section>
  );
}
...
function Title() {
  return (
    <section className="w-full md:max-w-2xl lg:max-w-md right-0 lg:absolute xl:right-32 py-4 ">
      <h1
        className={` text-foreground text-3xl text-balance text-center md:text-4xl  uppercase p-4 font-tds tracking-wider lg:text-left lg:text-5xl text-balance lg:text-background`}
      >
