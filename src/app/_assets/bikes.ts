    ...
    bikes: [
      {
        ...
        pakcageMaxRiders: 5,
        packages: [
          { id: 1, name: "tour", price: 300, days: 1, riders: 1 },
          { id: 2, name: "tour", price: 280, days: 1, riders: 2 },
          { id: 3, name: "tour", price: 270, days: 1, riders: 3 },
        ],
      },
    ],
  },
    ...
    bikes: [
      {
        ...
        description:
          "The KTM Duke is known for being the apex predator in it's domain, boasting the most powerful 125 engine on the market.",
        features: [
          "High-performance",
          "Lightweight",
          "Versatile",
