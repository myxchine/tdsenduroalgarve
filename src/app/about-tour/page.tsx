  ...
  return (
    <section>
      <Hero
        ...
        buttonLink2={null}
      />
      <div className="flex flex-col gap-4 py-12 w-full max-w-6xl mx-auto">
        <section className="flex flex-col p-6 gap-4">
          ...
          <Link href={`/bikes/ktm-exc-300`} className="w-full">
            <button className="flex flex-col w-full max-w-[200px] p-2 px-4 rounded bg-tdsRed text-white font-tds hover:bg-tdsRed/80 text-center justify-center items-center ">
              Available Packages
            </button>
          </Link>
        </section>
