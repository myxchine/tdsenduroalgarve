  ...
  return (
    <section className="flex flex-col items-center justify-center w-full relative">
      <div className="w-full relative flex flex-col items-center justify-center">
        ...
        <div className="absolute flex flex-col bottom-2 left-0 w-full  md:max-w-6xl  mx-auto md:right-0 md:h-screen md:items-end md:justify-center  md:w-screen md:text-left max-h-[700px] md:max-h-[1000px] lg:max-h-[1200px]">
